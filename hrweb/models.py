...
class Vacancy(models.Model):
    ...
    salary_min = models.IntegerField(verbose_name='Зарплата min', null=True, default=None)
    salary_max = models.IntegerField(verbose_name='Зарплата max', null=True, default=None)
